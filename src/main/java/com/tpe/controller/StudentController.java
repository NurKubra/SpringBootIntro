...
public class StudentController {
    ...
    @GetMapping
    @PreAuthorize("hasRole('ADMIN')")  //Bu method sadece ROLEADMIN bu istegi yapabilir !!
    ...
    {
        Pageable pageable = PageRequest.of(page, size, Sort.by(direction, prop)); //directionin prop'a gore siralanmais hali '
        Page<Student> studentsByPage = studentService.getAllStudentPaging(pageable);  //boilerplate code gibi dusunulebilir --> olmasi gerekiyor
    ...
    public String welcome(HttpServletRequest request) {
        ...
        logger.info("welcome mesajı  {}", request.getServletPath());  //{} buraya bir degisken gelek degeri sudur diiyp virgul sonrasinda yazdik
